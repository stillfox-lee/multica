...
export function CustomInput({ value, onChange, onSubmit, isMultiSelect = false }: CustomInputProps) {
  ...
  return (
    <div className="flex gap-2">
      <Input
        placeholder={isMultiSelect ? 'Type custom text for "Other" option...' : 'Or type a custom answer...'}
        value={value}
